...
//
// The lunar theory's periodic terms — GENERATED, do not edit by hand.
//
// ⚠ Written by tool/make_moon_tables.py from the published tables. The Moon is
// the hardest body in the sky to predict and the one a reader looks at most; a
// single mistyped coefficient here would move it by minutes of arc and look
// like a bug in the geometry rather than in a number.
//
// ⚠ Public domain: the ELP-2000/82 lunar theory, in the abridged form that has
// been printed and reimplemented for decades. Not anybody's software licence,
// which is why the iOS build can carry it.
//
// Each longitude/distance row is [D, M, M', F, sinCoefficient, cosCoefficient]
// — the first four are multiples of the Moon's fundamental arguments, the fifth
// contributes to longitude in units of 1e-6 degrees, and the sixth to distance
// in units of 1e-3 km. Each latitude row is [D, M, M', F, sinCoefficient].
library;

const lunarLongitudeAndDistance = <List<double>>[
...
const lunarLatitude = <List<double>>[
